    ...
    for num_steps in [100]:
        for red_agent in [B_lineAgent]:
            ...
            for i in range(MAX_EPS):
                ...
                print(dir(cyborg))
                print('Red agent state:',cyborg.get_agent_state('Red'))
                print('Blue_agent_state:',cyborg.get_agent_state('Blue'))
            ...
            with open(file_name, 'a+') as data:
                ...
                data.write(f'steps: {num_steps}, adversary: {red_agent.__name__}.\n')
                #data.write(f'ip_map:{ip_map}\n')
